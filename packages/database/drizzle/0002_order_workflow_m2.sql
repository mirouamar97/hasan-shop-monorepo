...
-- Extend order_status enum with M2 lifecycle values
...
-- Migrate legacy statuses to M2 equivalents
...
-- Prevent duplicate cart lines for same product+variant
